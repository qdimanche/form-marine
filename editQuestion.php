...
<form action="" class="space-y-6 flex flex-col lg:mx-60 mx-20 pt-32 pb-16  ">
    <div class="flex space-x-4 pb-10 border-b border-slate-200">
        ...
        <div class="flex flex-col space-y-2 relative w-1/2">
            ...
            <select name="categories" id="categories">
                <option value="<?php echo $res['categoryID'] ?>" selected disabled
                ...
                <div class="flex w-fit">
                    ...
                    <div class="">
                        <img src="assets/images/icons8-multiply-96.png"
                             class="w-4  cursor-pointer bottom-3 right-0 absolute" alt="">
                    </div>
    ...
    <div class="flex space-x-6 !mt-12">
        ...
        <a href=""
           class="bg-[#3D5A80]/60 hover:bg-[#3D5A80]/70 duration-300 text-white px-2 py-3 rounded-[10px] text-sm w-1/2 text-center">Ajouter
            une question</a>
        <a href=""
           class="bg-[#3D5A80]/60 hover:bg-[#3D5A80]/70 duration-300 text-white px-2 py-3 rounded-[10px] text-sm w-1/2 text-center">Ajouter
            une question</a>
