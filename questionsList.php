...
<form action="" class="space-y-6 flex flex-col lg:mx-60 mx-20 pt-32 pb-16  ">
  ...
  <div class="flex space-x-6 pt-4 relative">
    ...
    <div class="w-6">
      <img src="assets/images/icons8-multiply-96.png" class="w-4 absolute bottom-3 right-2 cursor-pointer" alt="">
    </div>
  </div>
  <div class="flex space-x-6 pt-4 relative">
    <div class="flex flex-col space-y-2 w-3/4">
      <label for="response1">Modifier votre réponse 2</label>
  ...
  <div class="flex space-x-6 pt-4 relative">
    <div class="flex flex-col space-y-2 w-3/4">
      <label for="response1">Modifier votre réponse 3</label>
  ...
  <div class="flex space-x-6 pt-4 relative">
    <div class="flex flex-col space-y-2 w-3/4">
      <label for="response1">Modifier votre réponse 4</label>
      <input id="response4" type="text" >
    </div>
    <div class="flex flex-col space-y-2 relative w-1/8">
